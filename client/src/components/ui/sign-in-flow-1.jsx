...
function MobileMenuPortal({ open, children, className, ...props }) {
  const [mounted, setMounted] = React.useState(false);
  ...
  if (!open || !mounted || typeof window === 'undefined' || !document.body) return null;
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Welcome to ParkBandhu</h1>
                      ...
                      <form onSubmit={handleEmailSubmit}>
                        <div className="relative">
                          <input 
                            ...
                            className="w-full backdrop-blur-[1px] text-white border-1 border-white/10 rounded-full py-3 px-4 focus:outline-none focus:border focus:border-white/30 text-center bg-black/50"
                            required
                          />
                          <button 
                            type="submit"
                  ...
                  >
                    ...
                    <div className="w-full">
                      <div className="relative rounded-full py-4 px-5 border border-white/10 bg-black/50">
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.25rem] text-white/50 font-light">Welcome to ParkBandhu</p>
                    </div>
